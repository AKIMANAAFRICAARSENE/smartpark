        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
            <div class="p-8 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-800">Service Reports</h2>
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('reports.cars') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                            Car Report
                        </a>
                    </div>
                </div>
                ...
                <!-- Filters -->
                <form method="GET" action="{{ route('reports.services') }}" class="mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg border border-gray-200">
                        <div class="px-6 py-6">
                            <dt class="text-sm font-medium text-gray-500 truncate">Average Revenue</dt>
                            <dd class="mt-2 text-3xl font-semibold text-gray-900">RWF {{ number_format($summary['average_revenue'], 0) }}</dd>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Records</th>
                                <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Revenue</th>
                                <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Average Revenue</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($serviceRecords as $record)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        RWF {{ number_format($record->average_revenue, 0) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
